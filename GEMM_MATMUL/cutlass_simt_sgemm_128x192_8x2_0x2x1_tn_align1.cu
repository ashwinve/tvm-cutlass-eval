...
cudaError_t CutlassGemmRCR(
  ...
  // Gemm operator cutlass_simt_sgemm_128x192_8x2_0x2x1_tn_align1
  using Operation_cutlass_simt_sgemm_128x192_8x2_0x2x1_tn_align1 = cutlass::gemm::device::Gemm<
    ...
    cutlass::gemm::GemmShape<1024.0, 67.0, 8>,
  ...
  Operation_cutlass_simt_sgemm_128x192_8x2_0x2x1_tn_align1 gemm_operator;
  Operation_cutlass_simt_sgemm_128x192_8x2_0x2x1_tn_align1::Arguments args({M, N, K},
                              {A, lda},
                              {B, ldb},
                              {C, ldc},
                              {C, ldc},
