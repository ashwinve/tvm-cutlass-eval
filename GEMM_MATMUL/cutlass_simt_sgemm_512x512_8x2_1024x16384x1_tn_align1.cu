...
cudaError_t CutlassGemmRCR(
  ...
  // Gemm operator cutlass_simt_sgemm_512x512_8x2_1024x16384x1_tn_align1
  using Operation_cutlass_simt_sgemm_512x512_8x2_1024x16384x1_tn_align1 = cutlass::gemm::device::Gemm<
    ...
    cutlass::arch::Sm50,
    cutlass::gemm::GemmShape<512, 512, 8>,
    cutlass::gemm::GemmShape<0, 0, 8>,
  ...
  Operation_cutlass_simt_sgemm_512x512_8x2_1024x16384x1_tn_align1 gemm_operator;
  Operation_cutlass_simt_sgemm_512x512_8x2_1024x16384x1_tn_align1::Arguments args({M, N, K},
                              {A, lda},
                              {B, ldb},
                              {C, ldc},
                              {C, ldc},
