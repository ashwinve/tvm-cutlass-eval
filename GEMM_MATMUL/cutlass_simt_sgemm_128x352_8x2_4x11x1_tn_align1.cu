...
cudaError_t CutlassGemmRCR(
  ...
  // Gemm operator cutlass_simt_sgemm_128x352_8x2_4x11x1_tn_align1
  using Operation_cutlass_simt_sgemm_128x352_8x2_4x11x1_tn_align1 = cutlass::gemm::device::Gemm<
    ...
    cutlass::arch::Sm75,
    cutlass::gemm::GemmShape<128, 352, 8>,
    cutlass::gemm::GemmShape<32.0, 32.0, 8>,
  ...
  Operation_cutlass_simt_sgemm_128x352_8x2_4x11x1_tn_align1 gemm_operator;
  Operation_cutlass_simt_sgemm_128x352_8x2_4x11x1_tn_align1::Arguments args({M, N, K},
                              {A, lda},
                              {B, ldb},
                              {C, ldc},
                              {C, ldc},
