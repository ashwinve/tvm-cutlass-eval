...
cudaError_t CutlassGemmRCR(
  ...
  // Gemm operator cutlass_simt_sgemm_64x320_8x2_2x10x1_tn_align1
  using Operation_cutlass_simt_sgemm_64x320_8x2_2x10x1_tn_align1 = cutlass::gemm::device::Gemm<
    ...
    cutlass::arch::Sm75,
    cutlass::gemm::GemmShape<64, 320, 8>,
  ...
  Operation_cutlass_simt_sgemm_64x320_8x2_2x10x1_tn_align1 gemm_operator;
  Operation_cutlass_simt_sgemm_64x320_8x2_2x10x1_tn_align1::Arguments args({M, N, K},
                              {A, lda},
                              {B, ldb},
                              {C, ldc},
                              {C, ldc},
