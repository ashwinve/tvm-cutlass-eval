...
cudaError_t CutlassGemmRCR(
  ...
  // Gemm operator cutlass_simt_sgemm_256x256_8x2_16x8x1_tn_align1
  using Operation_cutlass_simt_sgemm_256x256_8x2_16x8x1_tn_align1 = cutlass::gemm::device::Gemm<
  ...
  Operation_cutlass_simt_sgemm_256x256_8x2_16x8x1_tn_align1 gemm_operator;
  Operation_cutlass_simt_sgemm_256x256_8x2_16x8x1_tn_align1::Arguments args({M, N, K},
                              {A, lda},
                              {B, ldb},
                              {C, ldc},
                              {C, ldc},
